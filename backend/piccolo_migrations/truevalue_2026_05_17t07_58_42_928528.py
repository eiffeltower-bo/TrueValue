...
class Lead(Table, tablename="leads", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_table(
        class_name="Showing", tablename="showings", schema=None, columns=None
    )

    manager.add_column(
        table_class_name="Showing",
        tablename="showings",
        column_name="lead",
        db_column_name="lead",
